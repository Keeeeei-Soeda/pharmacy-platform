...
import { User, Building2, Eye, EyeOff, Mail, Lock, Phone, MapPin, FileText } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium text-gray-700 mb-2">
                  {formData.userType === 'pharmacist' ? '姓' : '担当者 姓'} <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-gray-700 mb-2">
                  {formData.userType === 'pharmacist' ? '名' : '担当者 名'} <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <User className="h-5 w-5 text-gray-400" />
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="pharmacyName"
                      type="text"
                      required={formData.userType === 'pharmacy'}
                ...
                <>
                  <div>
                    <label htmlFor="licenseNumber" className="block text-sm font-medium text-gray-700 mb-2">
                      薬剤師免許番号 <span className="text-red-500">*</span>
                    </label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      ...
                      <input
                        ...
                        name="licenseNumber"
                        type="text"
                        required={formData.userType === 'pharmacist'}
