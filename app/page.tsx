            ...
            <div className="flex flex-col gap-6 items-center mb-8">
              ...
              <div className="w-full max-w-2xl">
                ...
                <motion.div whileHover={{ scale: 1.02, y: -2 }} whileTap={{ scale: 0.98 }}>
                  <Link
                    href="/auth/register/pharmacist"
                    className="w-full px-10 py-5 bg-gradient-to-r from-teal-500 to-blue-600 text-white text-lg font-bold rounded-2xl shadow-2xl hover:shadow-3xl transition-all group inline-flex items-center justify-center gap-2"
                  >
                    薬剤師として無料登録
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05, y: -3 }} whileTap={{ scale: 0.98 }}>
              <Link
                href="/auth/register/pharmacist"
                className="px-8 sm:px-12 py-4 sm:py-6 bg-white text-blue-600 text-lg sm:text-xl font-black rounded-2xl shadow-2xl hover:shadow-3xl transition-all inline-flex items-center gap-3 group hover:bg-gray-50"
              >
                今すぐ無料登録
      ...
      <footer className="bg-gray-900 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="font-bold text-lg mb-4">薬ナビ</h3>
